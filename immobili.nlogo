...
"" ""
PENS
"prezzo-medio-case-sul-mercato" 1.0 0 -5298144 true "" "let prices [price] of patches with [house]\nlet avg-price 0\nifelse length prices != 0 [ \n  set avg-price mean prices\n  set price-history lput avg-price price-history\n  plot avg-price\n]\n;else\n[ set avg-price last price-history\n  plot avg-price\n]\n"
